...
console.log(balance.toString().replace('0','1'))//here we are converting number object to strings and now 
//we can use all string methods on it
console.log(balance.toFixed(2))//1000.00 
//it will convert number to in fixed two or more(given argument of methods)
// decimal points
...
console.log(Maths.ceil(4.2)) //5 it will give always greater number if we add decimal points
